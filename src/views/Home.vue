  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">王康AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/counseling')">
        <div class="card-glow"></div>
        <div class="app-icon counseling-icon">🧠</div>
        <div class="app-info">
          <div class="app-title">AI心理咨询</div>
          <div class="app-desc">专业心理顾问，帮你解答心理困扰</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: '王康AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '王康AI超级智能体应用平台提供AI心理咨询和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI心理咨询,AI助手,智能对话,王康,AI超级智能体,首页'
    }
  ]
})
